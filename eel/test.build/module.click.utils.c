...
static function_impl_code const function_table_click$utils[] = {
    impl_click$utils$$$function__2_safecall$$$function__1_wrapper,
    impl_click$utils$$$function__1__posixify,
    impl_click$utils$$$function__2_safecall,
    impl_click$utils$$$function__3_make_str,
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    int offset = Nuitka_Function_GetFunctionCodeIndex(function, function_table_click$utils);
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)Nuitka_Function_CreateFunctionViaCodeIndex(
        ...
        kw_defaults,
        doc,
        function_table_click$utils,
        sizeof(function_table_click$utils) / sizeof(function_impl_code)
    );
}
